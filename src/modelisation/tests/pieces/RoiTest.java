...
public class RoiTest {
	...
	public static void main(String[] args) {
		...
		Roi RE1 = new Roi("Roi", Couleur.BLANC, plateauJeu2.getCase(4, 0));
		plateauJeu2.getCase(4, 0).setOccupeePar(RE1);
		Roi RE8 = new Roi("Roi", Couleur.BLANC, plateauJeu2.getCase(4, 7));
		plateauJeu2.getCase(4, 7).setOccupeePar(RE8);
		
		Tour TA8 = new Tour("Tour", Couleur.NOIR, plateauJeu2.getCase(0, 7));
		plateauJeu2.getCase(0, 7).setOccupeePar(TA8); 
		Tour TB8 = new Tour("Tour", Couleur.NOIR, plateauJeu2.getCase(1, 7));
		plateauJeu2.getCase(1, 7).setOccupeePar(TB8); //Le grand roque noir est impossible, car une tour occupe B8
		Tour TH8 = new Tour("Tour", Couleur.NOIR, plateauJeu2.getCase(7, 7));
		plateauJeu2.getCase(7, 7).setOccupeePar(TH8);
		Tour TF7 = new Tour("Tour", Couleur.BLANC, plateauJeu2.getCase(5, 6)); //Le petit roque noir est impossible,
		plateauJeu2.getCase(7, 7).setOccupeePar(TF7); // car une tour ennemie contrôle F8
		
		Tour TA1 = new Tour("Tour", Couleur.BLANC, plateauJeu2.getCase(0, 0));
		plateauJeu2.getCase(0, 0).setOccupeePar(TA1); //le grand roque blanc est possible
		Tour TH1 = new Tour("Tour", Couleur.BLANC, plateauJeu2.getCase(7, 0));
